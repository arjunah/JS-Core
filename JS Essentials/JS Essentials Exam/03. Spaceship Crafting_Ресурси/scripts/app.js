function spaceshipCrafting() {
    ...
    let titCore = document.getElementById("titaniumCoreFound").value;
    let alCore = document.getElementById("aluminiumCoreFound").value;
    let magCore = document.getElementById("magnesiumCoreFound").value;
    let carCore = document.getElementById("carbonCoreFound").value;
    let lostCore = (document.getElementById("lossesPercent").value / 4) / 100;
    ...
    let availBars = document.getElementById("availableBars").getElementsByTagName("p")[0];
    availBars.innerHTML = barsOut;
    ...
    let spaceShips = document.getElementById("builtSpaceships").getElementsByTagName("p")[0];

    spaceShips.innerHTML = spaceOut.filter(s => s != "").join(", ");
}